...
My own takeaway from this part of the project was that blockchain is easy to describe in slogan form, but much harder to trust in practice once you look at keys, wallets, contracts, and external data feeds. That made the lab more useful than a purely theoretical summary because it showed where the security story is strong and where it still falls apart.
...
What stood out to me here was how clean the failure signal was. The chain did not just become "bad" in a vague sense; it failed for a specific, inspectable reason, which is exactly the kind of behavior I would want from a security control when something has been tampered with.
...
Across the course, I kept noticing the same pattern: the technology changes, but the security questions stay familiar. We still ask who is trusted, what can be forged, what can be recovered, and what happens when the attacker already has partial control.
...
If I were deploying this in a real environment, I would treat the governance and recovery plan as part of the security design, not as an afterthought. That is the difference between a system that is merely decentralized and one that is actually manageable under stress.
...
Overall, this was the part of the project where the security tradeoffs felt most concrete to me. The system can be elegant on paper and still be fragile in the places users actually touch, which is why I think the practical lab mattered more than just writing down definitions.
